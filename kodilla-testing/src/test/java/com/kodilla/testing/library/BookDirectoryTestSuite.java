...
public class BookDirectoryTestSuite {
        ...
        @Test
        public void testListBooksInHandsOf_noBorrowedBooks() {
            // Given
            LibraryDatabase libraryDatabaseMock = mock(LibraryDatabase.class);
            BookLibrary bookLibrary = new BookLibrary(libraryDatabaseMock);
            List<Book> resultListOf0Books = generateListOfNBooks(0);
            LibraryUser libraryUser = new LibraryUser("Jan", "Kowalski", "58721504876");
        ...
        @Test
        public void testListBooksInHandsOf_oneBorrowedBook() {
            // Given
            LibraryDatabase libraryDatabaseMock = mock(LibraryDatabase.class);
            BookLibrary bookLibrary = new BookLibrary(libraryDatabaseMock);
        ...
        @Test
        public void testListBooksInHandsOf_fiveBorrowedBooks() {
            // Given
            LibraryDatabase libraryDatabaseMock = mock(LibraryDatabase.class);
            BookLibrary bookLibrary = new BookLibrary(libraryDatabaseMock);
